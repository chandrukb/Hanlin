 ...
 */
NS_CLASS_AVAILABLE_IOS(6_0) @interface HNTextField : UITextField<UITextFieldDelegate>{
 ...
 */
-(void)addConfirmValidationTo:(HNTextField *)txtPassword withMsg:(NSString *)msg;
